  ...
  function load() {
    audioData = [{
      ...
      },
      {
        name: "Gimme Gimme",
        artist: "INNA",
        src: "https://github.com/cuneydbolukoglu/CodePen/blob/master/audioplayer/audio/2.mp3?raw=true"
      },
      {
        name: "'TMM TMM' prod. by Miksu",
        artist: "Summer Cem",
        src: "https://github.com/cuneydbolukoglu/CodePen/blob/master/audioplayer/audio/3.mp3?raw=true"
      }
    ];
